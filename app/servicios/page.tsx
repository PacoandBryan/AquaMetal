...
const services = [
    ...
    {
        id: "tornos-automaticos",
        icon: <Cpu size={32} />,
        title: "Tornos Automáticos",
        subtitle: "Alta Velocidad",
        description: "Producción eficiente de piezas pequeñas con tornos de levas automáticos. Ideal para componentes de alta precisión y volúmenes masivos.",
        specs: [
            "Maquinaria INDEX y TRAUB",
            "Diámetro: 12mm – 42mm",
            "Máxima eficiencia en serie",
        ],
