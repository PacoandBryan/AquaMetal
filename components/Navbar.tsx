                            ...
                            <button
                                onClick={() => {
                                    gtag.event({
                                        action: "click_cta",
                                        category: "engagement",
                                        label: "Navbar Cotizar",
                                    });
                                }}
                                className="group flex items-center gap-2 bg-accent-primary text-black px-5 py-2.5 rounded-full text-sm font-bold hover:bg-accent-secondary transition-colors shadow-[0_0_20px_rgba(197,160,89,0.3)] hover:shadow-[0_0_30px_rgba(197,160,89,0.5)]"
                            >
                                Cotizar
